...
export default function NavBar() {
  ...
  return (
    <nav className="fixed top-4 right-4 flex gap-6 z-50 px-4 py-2 rounded-full backdrop-blur-sm" style={{ background: 'color-mix(in srgb, var(--bg-top) 50%, transparent)' }}>
